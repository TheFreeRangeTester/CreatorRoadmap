...
import { Loader2, ArrowLeft, User, Trophy, RotateCcw, Settings } from "lucide-react";
          ...
          <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700 p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold flex items-center gap-2">
                ...
                {t("achievements.creatorStats", "Creator Statistics")}
              </h2>
              ...
              >
                ...
                {t("achievements.reset", "Reset Stats")}
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                <div className="text-sm text-muted-foreground mb-1">
                  {t("achievements.totalVotes", "Total Votes Received")}
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                <div className="text-sm text-muted-foreground mb-1">
                  {t("achievements.unlockedAchievements", "Unlocked Achievements")}
                </div>
                <div className="text-2xl font-bold">
            ...
            <p className="text-sm text-muted-foreground">
              {t("achievements.resetInfo", "Resetting will clear all your stats and progress. This cannot be undone.")}
            </p>
          </div>
        </div>
      </main>
