...
export default function AuthPage() {
  ...
  useEffect(() => {
    if (user) {
      ...
      if (
        (isDirect || attemptingCreatorLogin) &&
          ...
          <div className="mx-auto w-full max-w-md">
            <div className="flex justify-end w-full">
              <Tabs defaultValue="login" className="w-full">
                <TabsList
                  className={`grid w-full ${loginOnly ? "grid-cols-1" : "grid-cols-2"}`}
                >
                      ...
                      <CardDescription>
                        {loginOnly
                          ? t(
                              ...
                              "Inicia sesión para votar en este perfil de creador"
                            )
