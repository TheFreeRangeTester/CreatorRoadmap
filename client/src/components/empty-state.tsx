...
export default function EmptyState({ onAddIdea }: EmptyStateProps) {
  return (
    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow dark:shadow-gray-900/30 text-center">
      ...
      <h3 className="mt-2 text-sm font-medium text-neutral-700 dark:text-neutral-200">No ideas yet</h3>
      <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Get started by creating a new idea.</p>
      <div className="mt-6">
        {onAddIdea ? (
