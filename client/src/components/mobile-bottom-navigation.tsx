...
import { Lightbulb, ListFilter, Gift, Package, Badge as BadgeIcon } from "lucide-react";
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <motion.div
                  className={cn("absolute -top-0.5 left-1/2 w-8 h-1 rounded-full", tab.color.replace('text-', 'bg-'))}
                  layoutId="activeTab"
                  initial={false}
                  animate={{ x: "-50%" }}
