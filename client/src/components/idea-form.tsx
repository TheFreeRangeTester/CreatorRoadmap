...
export default function IdeaForm({ isOpen, idea, onClose }: IdeaFormProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[600px] rounded-sm bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-xl p-0 w-full max-w-none overflow-hidden">
          ...
          >
                ...
                <FormItem className="space-y-3">
                  ...
                  <FormControl>
                    <Input
                      ...
                      className="h-12 rounded-sm border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 px-4"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
                ...
                <FormItem className="space-y-3">
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      maxLength={280}
                      className="resize-none h-28 rounded-sm border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 px-4 py-3"
                      disabled={isLimitReached}
                      {...field}
                    />
                  </FormControl>
                  ...
                  <FormControl>
                    {showCustomNiche ? (
                      ...
                      <Select
                        ...
                        disabled={isLimitReached}
                      >
                        <SelectTrigger className="h-12 rounded-sm border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 text-gray-900 dark:text-white px-4">
                          <SelectValue
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-8 px-8 pb-8 border-t border-gray-100 dark:border-gray-800">
              <Button
                ...
                variant="outline"
                onClick={onClose}
                className="flex-1 sm:flex-none h-12 rounded-sm border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium transition-all duration-200"
              >
              ...
              {!isLimitReached && (
                <Button
                  ...
                  className="flex-1 sm:flex-none h-12 rounded-sm bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {createMutation.isPending || updateMutation.isPending ? (
